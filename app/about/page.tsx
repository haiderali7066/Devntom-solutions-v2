...
const SERVICES = [
  { icon: Globe,      name: "Custom Website Development",         href: "/services/website-development" },
  { icon: Code2,      name: "Web Applications & SaaS Platforms",  href: "/services/software-development" },
  { icon: Bot,        name: "AI Automation & Chatbots",           href: "/services/ai-automation" },
  ...
  { icon: Smartphone, name: "Business Systems & Dashboards",      href: "/services/software-development" },
];
...
const SOCIALS = [
  { icon: Instagram, label: "Instagram",    href: "https://instagram.com/devntom.solutions", handle: "@devntom.solutions", live: true },
  { icon: Facebook,  label: "Facebook",     href: "#",    handle: "Coming Soon", live: false },
  { icon: Linkedin,  label: "LinkedIn",     href: "#",    handle: "Coming Soon", live: false },
  {
    icon: Twitter, label: "X / Twitter",  href: "#",    handle: "Coming Soon", live: false,
  },
  {
    label: "Pinterest", href: "#", handle: "Coming Soon", live: false,
    icon: () => (
  ...
  {
    label: "Reddit", href: "#", handle: "Coming Soon", live: false,
    icon: () => (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Stack Overflow", href: "#", handle: "Coming Soon", live: false,
    icon: () => (
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
            ...
            <motion.div {...fadeUp(0.12)} className="relative h-[520px]">
              <div className="absolute top-0 right-0 w-[72%] h-[58%] rounded-2xl overflow-hidden">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=700&auto=format&fit=crop&q=80" className="w-full h-full object-cover" alt="Team" />
              ...
              <div className="absolute bottom-0 left-0 w-[62%] h-[52%] rounded-2xl overflow-hidden border border-white/[0.06]">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?w=600&auto=format&fit=crop&q=80" className="w-full h-full object-cover" alt="Work" />
